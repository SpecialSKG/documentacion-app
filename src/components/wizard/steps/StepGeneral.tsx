...
export default function StepGeneral() {
  ...
  const { ambitoOptions, sitiosOptions, requiereReportesOptions } =
    useDataOptions();
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          <div className="flex items-start justify-between gap-3">
            ...
            <Button type="button" variant="outline" size="sm" onClick={handleLoadDemoData}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder="Nombre del contacto responsable"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
      ...
      <div className="flex items-center gap-2 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        <p className="text-sm text-blue-800">
          💡 <strong>Tip:</strong> Los datos se guardan automáticamente. Puedes
          continuar al siguiente paso cuando estés listo.
        </p>
      </div>
    </div>
  );
